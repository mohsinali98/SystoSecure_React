...
const AdminLogin = () => {
    ...
    if (auth.getCurrentUser() && auth.getCurrentUser().isAdmin) return <Redirect to='/admin/home' />
                ...
                <div style={{ marginTop: "10%" }} className="col-sm">
                    <Container maxWidth="sm">
                        <m.Card className={classes.root} variant="outlined">
                            <m.CardContent>
                                <SupervisedUserCircleIcon className={classes.title} />
                            </m.CardContent>
                            <form onSubmit={handleSubmit} noValidate autoComplete="off">
                                <div className="mb-4" style={{ marginLeft: '15%' }}>
                                    <label htmlFor="username" className="form-label m-2">Username</label>
                                    <m.TextField id="username" name="username" label="Username" variant="outlined" onChange={handleChange} autoFocus={true} />
                            ...
                            <div style={{ marginTop: '2%', marginBottom: "1em" }}>
                                <Link className={classes.pos} to='/admin/register' >Create New Account</Link>
                            </div>
                        </m.Card>
                    </Container>
                </div>
