                ...
                <div style={{ marginTop: "8%" }} className="col-sm">
                    <Container maxWidth="sm">
                        <m.Card className={classes.root} variant="outlined">
                            <m.CardContent>
                                <GroupAddIcon className={classes.title} />
                            </m.CardContent>
                            <form onSubmit={handleSubmit} noValidate autoComplete="off">
                                ...
                                <div className="mb-4" style={{ marginLeft: '15%' }}>
                                    ...
                                    <m.TextField id="username" name="username" label="Username" variant="outlined" onChange={handleChange} required={true} />
                            ...
                            <div style={{ marginTop: '2%', marginBottom: "1em" }}>
                                <Link className={classes.pos} to='/admin' >Already Has Account?</Link>
                            </div>
                        </m.Card>
                    </Container>
                </div>
